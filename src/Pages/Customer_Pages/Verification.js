  ...
  const verify2 = async () => {
    try {
      const response = await axios.post(
        "http://127.0.0.1:8000/api/auth/verify-user-email",
        allParams
      );
        ...
        <div className="bg-light ">
          <div className=" container w-75 m-auto text-center pt-5">
            ...
            <div
              className={
                "alert alert-primary " +
                (verified === 0 ? "visible" : "invisible")
              }
              role="alert"
            >
              <div>
                <img src={loading} height={40} className="verImg"></img> Please
                wait..
              </div>
            </div>
            <div
              className={
                "verified " + (verified === 1 ? "visible" : "invisible")
              }
            >
              <img
                src={verifiedLogo}
              ...
              ></img>
              <br></br>
              Congratulations! your email got verified now you can continue to{" "}
