        ...
        nameError:
          event.target.value.length === 0
            ...
            : event.target.value.length < 3 &&
              "Please Insert a Valid Name,not less that 3 letters",
      });
      ...
      <div className="bg-light ">
        <div className="container text-center w-50 border border-dark-subtle my-5">
          ...
          <form className="text-center">
            <div>
              <label for="name" className="justify-content-center">
                Name:
              </label>
            ...
            <br></br>
            <div>
              <label for="email" className="justify-content-center">
                Email:
              </label>
            ...
            <br></br>
            <div>
              <label for="phone" className="justify-content-center">
                phone:
              </label>
            ...
            <br></br>
            <div>
              <label for="password" className="justify-content-center">
                Password:
              </label>
            ...
            <button
              className="btn primary my-3 mx-auto reg-btn"
              type="button"
