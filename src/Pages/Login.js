      ...
      <div className="w-50 color-dark admin-login mx-auto my-5  text-center">
        ...
        <form className="mx-auto w-75 pb-5" onSubmit={handleSubmit}>
          <div>
            ...
            <label for="email" className="form-label justify-content-center">
              Email:
            </label>
          ...
          <div>
            <label
              for="password"
              className="form-label mt-3 justify-content-center"
            >
              Password:
            </label>
          ...
          <div className=" text-center pb-2">
            <a href="" className="pb-3 pl-1" onClick={resetPassword}>
              <p>Forgot password</p>
            </a>
